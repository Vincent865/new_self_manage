function MODBUSController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
MODBUSController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.MODBUSController", MODBUSController);