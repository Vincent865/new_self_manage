function SNMPController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
SNMPController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.SNMPController", SNMPController);