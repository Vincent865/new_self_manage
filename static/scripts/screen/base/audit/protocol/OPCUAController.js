function OPCUAController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
OPCUAController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.OPCUAController", OPCUAController);