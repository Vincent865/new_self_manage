function HTTPController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
HTTPController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.HTTPController", HTTPController);