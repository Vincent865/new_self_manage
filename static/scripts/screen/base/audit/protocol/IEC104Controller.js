function IEC104Controller(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
IEC104Controller.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.IEC104Controller", IEC104Controller);