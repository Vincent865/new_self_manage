function ENIPTCPController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
ENIPTCPController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.ENIPTCPController", ENIPTCPController);