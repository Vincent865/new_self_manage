function DNP3Controller(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
DNP3Controller.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.DNP3Controller", DNP3Controller);