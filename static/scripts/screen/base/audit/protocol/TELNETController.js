function TELNETController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
ContentFactory.assignToPackage("tdhx.base.audit.TELNETController", TELNETController);