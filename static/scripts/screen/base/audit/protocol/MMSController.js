function MMSController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
ContentFactory.assignToPackage("tdhx.base.audit.MMSController", MMSController);