function ENIPIOController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
ENIPIOController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.ENIPIOController", ENIPIOController);