function SMTPController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
SMTPController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.SMTPController", SMTPController);