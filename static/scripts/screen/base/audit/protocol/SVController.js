function SVController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
SVController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.SVController", SVController);