function S7Controller(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
S7Controller.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.S7Controller", S7Controller);