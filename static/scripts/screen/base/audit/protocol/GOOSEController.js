function GOOSEController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
GOOSEController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.GOOSEController", GOOSEController);