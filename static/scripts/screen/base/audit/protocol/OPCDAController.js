function OPCDAController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
OPCDAController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.OPCDAController", OPCDAController);