function ENIPUDPController(controller, viewHandle, elementId, id, ip, mac, port, time, protocol) {
...
ENIPUDPController.prototype.selectProtocol = function () {
    var html = "";
    var parent = this;
    try {
...
ContentFactory.assignToPackage("tdhx.base.audit.ENIPUDPController", ENIPUDPController);